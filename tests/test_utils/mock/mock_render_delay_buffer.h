...
#ifndef TESTS_TEST_UTILS_MOCK_MOCK_RENDER_DELAY_BUFFER_H_
#define TESTS_TEST_UTILS_MOCK_MOCK_RENDER_DELAY_BUFFER_H_
...
#endif  // TESTS_TEST_UTILS_MOCK_MOCK_RENDER_DELAY_BUFFER_H_
