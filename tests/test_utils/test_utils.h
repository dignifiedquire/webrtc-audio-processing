...
// wav_file.h not available in this project - stub out WavReader/WavWriter
namespace webrtc {
class WavReader;
class WavWriter;
}  // namespace webrtc
...
// Note: WavReader/WavWriter not available in this project - class is stubbed.
class ChannelBufferWavReader final {
 ...
 private:
  WavReader* file_ = nullptr;  // Stubbed - not used
...
class ChannelBufferWavWriter final {
 ...
 private:
  WavWriter* file_ = nullptr;  // Stubbed - not used
  std::vector<float> interleaved_;
};
